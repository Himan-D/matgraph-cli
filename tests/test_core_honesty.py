...
@patch("matgraph.core.get_matgl_eform_model")
def test_band_gap_is_none(mock_eform, *_):
    mock_eform.return_value.predict_structure.return_value.detach.return_value.item.return_value = -0.4
